...
请从 GitHub 仓库的 **Releases** 页面下载 v0.3.9，不要从不明来源获取修改版程序。

| 发布包 | 适用场景 |
| --- | --- |
| `聚窗-v0.3.9-轻量版.zip` | 体积小；电脑需已安装 .NET 8 Desktop Runtime x64 |
| `聚窗-v0.3.9-免运行库版.zip` | 体积较大；无需单独安装 .NET 运行库 |
